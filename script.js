...
// API setup
const API_KEY = "AIzaSyCxPJ5-ZXuHFTv3s5eozQ_4lAlgOoN3eVw"; 
...
// Menyimpan seluruh riwayat percakapan
const chatHistory = [];

// Simpan tinggi awal input untuk reset nantinya
const initialInputHeight = messageInput.scrollHeight;

// Buat elemen pesan dengan isi dan class tertentu
...
// Fungsi untuk meminta respons bot dari API
const generateBotResponse = async (incomingMessageDiv) => {
    const MessageElement = incomingMessageDiv.querySelector(".message-text");

    // Siapkan bagian pesan user (dan file jika ada)
    ...
    try {
        ...
        // Ambil dan format respons teks dari API
        const apiResponseText = data.candidates[0].content.parts[0].text
            .replace(/\*\*(.*?)\*\*/g, "$1")  // Hilangkan bold markdown
            .replace(/\*(.*?)\*/g, "$1")      // Hilangkan italic markdown
            .replace(/^\* /gm, "• ")          // Ubah * jadi bullet
            .replace(/\n{2,}/g, "<br><br>")   // Paragraf
            .replace(/\n/g, "<br>")           // Baris baru
            .trim();
        ...
        // Simpan respons bot ke chatHistory
        chatHistory.push({
            role: "model",
        ...
        // Reset file, hapus loading, scroll ke bawah
        userData.file = {};
...
// Handle ketika user kirim pesan
...
// Event listener tombol-tombol UI
